...
df.select(sumDistinct("Sales")).show() //1.sumDistinct

df.select(last("Company")).show() //2.last

df.select(first("Person")).show() //3.first

df.select(var_pop("Sales")).show() //4.var_pop

df.select(avg("Sales")).show() //5.avg

df.select(collect_list("Sales")).show() //6.collect_list

df.select(var_samp("Sales")).show() //7.var_samp

df.select(sum("Sales")).show() //8.sum

df.select(stddev_pop("Sales")).show() //9.stddev_pop

df.select(skewness("Sales")).show() //10.skewness
 
df.select(min("Sales")).show() //11.min

df.select(kurtosis("Sales")).show() //12.kurtosis

df.select(collect_set("Sales")).show() //13.collect_set

df.select(approx_count_distinct("Company")).show() //14.approx_count_distinct

df.select(mean("Sales")).show() //15.mean

df.select(variance ("Sales")).show() //16.variance

df.select(trunc("Sales")).show() //17.trunc

df.select(bin("Sales")).show() //18.bin

df.select(shuffle("Sales")).show()//19.shuffle

df.select(abs("Sales")).show() //20.abs
