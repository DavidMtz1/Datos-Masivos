...
- [Logistic Regression] (#logsitic-regression)
- [Multilayer Perceptron] (#multilayer-perceptron-classifier)
...
![Alt text] (images/Desiciontree().png "Decision Tree")
...
![Alt text] (images/Logisticregression1().png "Logistic Regression")
...
![Alt text] (images/spark().png "Spark and Scala")

As a code editor we use visual studio, this is quite simple to use and interactive.

![Alt text] (images/visual().png "Visual Studio Code")
